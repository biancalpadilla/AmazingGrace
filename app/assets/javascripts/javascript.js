// javascript.js files are for IDE.
// IDE is on hold and not for live release.
//
...
// 					}
// 				}
// 				$.get("defaults/data.javascript?" + iMilli, function(resp) {
// 					def.data = resp;
// 					areWeThereYet();
// 				}, "text");
...
// 	var editors = [
// 		{ name: "data", id: "preData", mode: require("ace/mode/javascript").Mode  },
